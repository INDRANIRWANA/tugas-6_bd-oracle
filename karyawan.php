                        ...
                        <td class="td-actions">
						  <a class='btn btn-success' href="edit_pembeli.php?id_pembeli=<?php echo $d["ID_KARYAWAN"];?>" 
							><i class='fa fa-edit'></i></a>
                              ...
                              <a class='btn btn-danger' onclick="return confirm('Anda yakin ingin menghapus data tersebut?');" href="aksi_karyawan.php?act=delete&id_karyawan=<?php echo $d["ID_KARYAWAN"];?>" 
